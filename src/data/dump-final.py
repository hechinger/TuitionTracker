...
for row in data:
    ...
    institution['alias'] = row['Institution name alias (HD2020)'] # 
    institution['city'] = row['City location of institution (HD2020)'] 
    institution['abbreviation'] = row['State abbreviation (HD2020)'] 
    institution['hbcu'] = convertInt(row['Historically Black College or University (HD2020)'])
    institution['tribal_college'] = convertInt(row['Tribal college (HD2020)'])
    institution['level'] = convertInt(row['Sector of institution (HD2020)'])


    enrollment = [
        ('perc_sticker',convertInt(row['Sticker'])),
        ('perc_admitted',convertInt(row['Admitted'])),
        ("enrollment_unknown",convertInt(row["Race/ethnicity unknown total (EF2019A  All students  Undergraduate total)"])),
        ("enrollment_twomore",convertInt(row["Two or more races total (EF2019A  All students  Undergraduate total)"])),
        ("enrollment_white",convertInt(row["White total (EF2019A  All students  Undergraduate total)"])),
        ("enrollment_hisp",convertInt(row["Hispanic total (EF2019A  All students  Undergraduate total)"])),
        ("enrollment_nathawpacisl",convertInt(row["Native Hawaiian or Other Pacific Islander total (EF2019A  All students  Undergraduate total)"])),
        ("enrollment_black",convertInt(row["Black or African American total (EF2019A  All students  Undergraduate total)"])),
        ("enrollment_asian",convertInt(row["Asian total (EF2019A  All students  Undergraduate total)"])),
        ("enrollment_amerindalasknat",convertInt(row["American Indian or Alaska Native total (EF2019A  All students  Undergraduate total)"])),
        ("enrollment_nonresident",convertInt(row["Nonresident alien total (EF2019A  All students  Undergraduate total)"])),
        ("total_men",convertInt(row["Grand total men (EF2019A  All students  Undergraduate total)"])),
        ("total_women",convertInt(row["Grand total women (EF2019A  All students  Undergraduate total)"])),
        ("total_enrollment",convertInt(row["Grand total (EF2019A  All students  Undergraduate total)"]))
    ...
    years_list_20_21 = [
        ...
        ("avg_net_price_0_30000_titleiv_privateforprofit",parseFloat(row["Multiplier (income 0-30 000)-students awarded Title IV federal financial aid"])),
        ("avg_net_price_30001_48000_titleiv_privateforprofit",parseFloat(row["Multiplier (income 30 001-48 000)-students awarded Title IV federal financial aid"])),
        ("avg_net_price_48001_75000_titleiv_privateforprofit",parseFloat(row["Multiplier (income 48 001-75 000)-students awarded Title IV federal financial aid"])),
        ("avg_net_price_75001_110000_titleiv_privateforprofit",parseFloat(row["Multiplier (income 75 001-110 000)-students awarded Title IV federal financial aid"])),
        ("avg_net_price_110001_titleiv_privateforprofit",parseFloat(row["Multiplier (income over 110 000)-students awarded Title IV federal financial aid"])),
    ]
    ...
    years_list_19_20 = [
        ...
        ("avg_net_price_0_30000_titleiv_privateforprofit",(parseFloat(row["Multiplier (income 0-30 000)-students awarded Title IV federal financial aid  2018-19 (SFA1819)"]))),
        ("avg_net_price_30001_48000_titleiv_privateforprofit",(parseFloat(row["Multiplier (income 30 001-48 000)-students awarded Title IV federal financial aid  2018-19 (SFA1819)"]))),
        ("avg_net_price_48001_75000_titleiv_privateforprofit",(parseFloat(row["Multiplier (income 48 001-75 000)-students awarded Title IV federal financial aid  2018-19 (SFA1819)"]))),
        ("avg_net_price_75001_110000_titleiv_privateforprofit",(parseFloat(row["Multiplier (income 75 001-110 000)-students awarded Title IV federal financial aid  2018-19 (SFA1819)"]))),
        ("avg_net_price_110001_titleiv_privateforprofit",(parseFloat(row["Multiplier (income over 110 000)-students awarded Title IV federal financial aid  2018-19 (SFA1819)"]))),
    ]
    ...
    years_list_18_19 = [
            ...
            ("avg_net_price_0_30000_titleiv_privateforprofit",parseFloat(row["Average net price (income 0-30 000)-students awarded Title IV federal financial aid  2018-19 (SFA1819)"])),
            ("avg_net_price_30001_48000_titleiv_privateforprofit",parseFloat(row["Average net price (income 30 001-48 000)-students awarded Title IV federal financial aid  2018-19 (SFA1819)"])),
            ("avg_net_price_48001_75000_titleiv_privateforprofit",parseFloat(row["Average net price (income 48 001-75 000)-students awarded Title IV federal financial aid  2018-19 (SFA1819)"])),
            ("avg_net_price_75001_110000_titleiv_privateforprofit",parseFloat(row["Average net price (income 75 001-110 000)-students awarded Title IV federal financial aid  2018-19 (SFA1819)"])),
            ("avg_net_price_110001_titleiv_privateforprofit",parseFloat(row["Average net price (income over 110 000)-students awarded Title IV federal financial aid  2018-19 (SFA1819)"])),
            ...
            # ("number_income_privateforprofit_0_30000",convertInt(row["Number in income level (0-30 000)  2018-19 (SFA1819)"])),
            # ("number_income_privateforprofit_30001_48000",convertInt(row["Number in income level (30 001-48 000)  2018-19 (SFA1819)"])),
            # ("number_income_privateforprofit_48001_75000",convertInt(row["Number in income level (48 001-75 000)  2018-19 (SFA1819)"])),
            # ("number_income_privateforprofit_75001_100000",convertInt(row["Number in income level (75 001-110 000)  2018-19 (SFA1819)"])),
            # ("number_income_privateforprofit_110001",convertInt(row["Number in income level (110 001 or more)  2018-19 (SFA1819)"])),
    ...
    years_list_17_18 = [
            ...
            ("avg_net_price_0_30000_titleiv_privateforprofit",parseFloat(row["Average net price (income 0-30 000)-students awarded Title IV federal financial aid  2017-18 (SFA1718)"])),
            ("avg_net_price_30001_48000_titleiv_privateforprofit",parseFloat(row["Average net price (income 30 001-48 000)-students awarded Title IV federal financial aid  2017-18 (SFA1718)"])),
            ("avg_net_price_48001_75000_titleiv_privateforprofit",parseFloat(row["Average net price (income 48 001-75 000)-students awarded Title IV federal financial aid  2017-18 (SFA1718)"])),
            ("avg_net_price_75001_110000_titleiv_privateforprofit",parseFloat(row["Average net price (income 75 001-110 000)-students awarded Title IV federal financial aid  2017-18 (SFA1718)"])),
            ("avg_net_price_110001_titleiv_privateforprofit",parseFloat(row["Average net price (income over 110 000)-students awarded Title IV federal financial aid  2017-18 (SFA1718)"])),
            ...
            # ("number_income_privateforprofit_0_30000",convertInt(row["Number in income level (0-30 000)  2017-18 (SFA1718)"])),
            # ("number_income_privateforprofit_30001_48000",convertInt(row["Number in income level (30 001-48 000)  2017-18 (SFA1718)"])),
            # ("number_income_privateforprofit_48001_75000",convertInt(row["Number in income level (48 001-75 000)  2017-18 (SFA1718)"])),
            # ("number_income_privateforprofit_75001_100000",convertInt(row["Number in income level (75 001-110 000)  2017-18 (SFA1718)"])),
            # ("number_income_privateforprofit_110001",convertInt(row["Number in income level (110 001 or more)  2017-18 (SFA1718)"])),

            ("grad_rate_associate_3years_total",parseFloat(row["COMPLETION Grand total"])),

            ("grad_rate_associate_3years_white",parseFloat(row["COMPLETION White"])),
            ("grad_rate_associate_3years_black",parseFloat(row["COMPLETION Black or African American"])),
            ("grad_rate_associate_3years_hisp",parseFloat(row["COMPLETION Hispanic"])),
            ("grad_rate_associate_3years_amerindalasknat",parseFloat(row["COMPLETION American Indian or Alaska Native"])),
            ("grad_rate_associate_3years_unknown",parseFloat(row["COMPLETION Race/ethnicity unknown"])),
            ("grad_rate_associate_3years_asian",parseFloat(row["COMPLETION Asian"])),
            ("grad_rate_associate_3years_nathawpacisl",parseFloat(row["COMPLETION Native Hawaiian Pac Islander"])),
            ("grad_rate_associate_3years_twomore",parseFloat(row["COMPLETION Two or more races"])),
            ...
            ("grad_rate_bachelors_6years_total",parseFloat(row["COMPLETION Grand total"])),

            ("grad_rate_bachelors_6years_white",parseFloat(row["COMPLETION White"])),
            ("grad_rate_bachelors_6years_black",parseFloat(row["COMPLETION Black or African American"])),
            ("grad_rate_bachelors_6years_hisp",parseFloat(row["COMPLETION Hispanic"])),
            ("grad_rate_bachelors_6years_amerindalasknat",parseFloat(row["COMPLETION American Indian or Alaska Native"])),
            ("grad_rate_bachelors_6years_unknown",parseFloat(row["COMPLETION Race/ethnicity unknown"])),
            ("grad_rate_bachelors_6years_twomore",parseFloat(row["COMPLETION Two or more races"])),
            ("grad_rate_bachelors_6years_asian",parseFloat(row["COMPLETION Asian"])),
            ("grad_rate_bachelors_6years_nathawpacisl",parseFloat(row["COMPLETION Native Hawaiian Pac Islander"])),
        ]
    ...
    years_list_15_16 = [
        ...
        # ("number_income_privateforprofit_0_30000",convertInt(row["Number in income level (0-30 000)  2015-16 (SFA1516)"])),
        # ("number_income_privateforprofit_30001_48000",convertInt(row["Number in income level (30 001-48 000)  2015-16 (SFA1516)"])),
        # ("number_income_privateforprofit_48001_75000",convertInt(row["Number in income level (48 001-75 000)  2015-16 (SFA1516)"])),
        # ("number_income_privateforprofit_75001_100000",convertInt(row["Number in income level (75 001-110 000)  2015-16 (SFA1516)"])),
        # ("number_income_privateforprofit_110001",convertInt(row["Number in income level (110 001 or more)  2015-16 (SFA1516)"])),
   ]
    ...
    years_list_13_14 = [
        ...
        ("price_instate_oncampus",parseFloat(row["Total price for in-state students living on campus 2013-14 (DRVIC2013_RV)"])),
        # ("price_outofstate_oncampus",parseFloat(row["Total price for out-of-state students living on campus 2013-14 (DRVIC2013)"])),
        ("price_instate_offcampus_nofamily",parseFloat(row["Total price for in-state students living off campus (not with family)  2013-14 (DRVIC2013_RV)"])),
    ...
    years_list_12_13 = [
        ...
        ("price_instate_oncampus",parseFloat(row["Total price for in-state students living on campus 2012-13 (DRVIC2012_RV)"])),
        # ("price_outofstate_oncampus",parseFloat(row["Total price for out-of-state students living on campus 2012-13 (DRVIC2012)"])),
        ("price_instate_offcampus_nofamily",parseFloat(row["Total price for in-state students living off campus (not with family)  2012-13 (DRVIC2012_RV)"])),
    ...
    years_list_11_12 = [
        ...
        ("price_instate_oncampus",parseFloat(row["Total price for in-state students living on campus 2011-12 (DRVIC2011_RV)"])),
        # ("price_outofstate_oncampus",parseFloat(row["Total price for out-of-state students living on campus 2011-12 (DRVIC2011)"])),
        ("price_instate_offcampus_nofamily",parseFloat(row["Total price for in-state students living off campus (not with family)  2011-12 (DRVIC2011_RV)"])),
    ...
    years_list_10_11 = [
        ...
        ("price_instate_oncampus",parseFloat(row["Total price for in-state students living on campus 2010-11 (DRVIC2010_RV)"])),
        # ("price_outofstate_oncampus",parseFloat(row["Total price for out-of-state students living on campus 2010-11 (DRVIC2010)"])),
        ("price_instate_offcampus_nofamily",parseFloat(row["Total price for in-state students living off campus (not with family)  2010-11 (DRVIC2010_RV)"])),
    ...
    years_list_09_10 = [
        ...
        ("price_instate_oncampus",parseFloat(row["Total price for in-state students living on campus 2009-10 (DRVIC2009_RV)"])),
        # ("price_outofstate_oncampus",parseFloat(row["Total price for out-of-state students living on campus 2009-10 (DRVIC2009)"])),
        ("price_instate_offcampus_nofamily",parseFloat(row["Total price for in-state students living off campus (not with family)  2009-10 (DRVIC2009_RV)"])),
    ...
    years_list_08_09 = [
        ...
        ("price_instate_oncampus",parseFloat(row["Total price for in-state students living on campus 2008-09 (DRVIC2008_RV)"])),
        # ("price_outofstate_oncampus",parseFloat(row["Total price for out-of-state students living on campus 2008-09 (DRVIC2008)"])),
        ("price_instate_offcampus_nofamily",parseFloat(row["Total price for in-state students living off campus (not with family)  2008-09 (DRVIC2008_RV)"])),
    ...
    outfile = open("./school-data-refresh/{}.json".format(row["UnitID"]),"w")
